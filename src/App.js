  ...
  <div className="max-w-6xl mx-auto p-6 bg-gray-50 min-h-screen">
    ...
    <div className="bg-white rounded-lg shadow-lg p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">{/* Left column content starts here */}
<div className="bg-blue-50 p-6 rounded-lg">
          ...
          {/* Enhanced Grocery Emissions Section with Receipt Analysis */}
                ...
                <div className="bg-white p-4 rounded-lg border space-y-4">
                    ...
                    {!privacyConsent && (
                      <div className="mt-4 p-3 bg-yellow-100 border border-yellow-300 rounded-lg">
                        <p className="text-sm text-yellow-800">
                          <strong>Please accept the privacy terms above to enable file upload and photo capture.</strong>
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      disabled={!formData.receiptAnalysisApiUrl || !privacyConsent}
                    >
                      <Plus className="mr-2" size={16} />
                      Upload Receipt
                    </button>
                    <button
                      ...
                      className="bg-blue-600 text-white px-4 py-2 
						  rounded-lg hover:bg-blue-700 flex items-center justify-center"
